...
int main(int argc, char *argv[]) {
  QApplication application(argc, argv);
    application.setWindowIcon(QIcon(":/resources/img/logo.jpeg"));
  int id = QFontDatabase::addApplicationFont(":/fonts/font/LiberationMono-Regular.ttf");
//  int id = QFontDatabase::addApplicationFont(":/fonts/font/JetBrainsMono.ttf");
