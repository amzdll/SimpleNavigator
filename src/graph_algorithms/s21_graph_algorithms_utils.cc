...
void GraphAlgorithms::UpdateCost(int vertex, Matrix& adjacency_matrix,
...
int GraphAlgorithms::GetIndexOfVertex(int vertex, Matrix& adjacency_matrix) {
...
bool GraphAlgorithms::Contains(const std::queue<int>& queue, int elem) {
  std::queue<int> temporary_queue(queue);
